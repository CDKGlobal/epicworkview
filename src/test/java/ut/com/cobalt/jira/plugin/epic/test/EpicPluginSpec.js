describe('ProjectController', function(){
    ...
    beforeEach(angular.mock.inject(function($rootScope, $controller, $httpBackend, $http,$cookieStore){
        ...
        "avatar":"/jira/secure/useravatar?avatarId=10122"},"completed":true,"sub-tasks":[]}]}]},
        ...
        "timestamp":1405430614000,"stories":[{"name":"newissue","key":"TEST-2",
        "id":10100, "timestamp":1405430614987,"completed":false,"sub-tasks":[]}]}]},    
        {"name":"Project4","description":"","key":"WIRED","id":10400,"timestamp":1405458785061,
        "epics":[{"name":"epic for today","description":"eipc for today test","key":"WIRED-1",
        "id":10400,"timestamp":1405458785061,"contributor":{"id":"admin","name":"admin",
        "avatar":"/jira/secure/useravatar?avatarId=10122"},"stories":[{"name":"story1",
        "key":"WIRED-2","id":10401,"timestamp":1405457509149,"contributor":{"id":"admin",
        "name":"admin","avatar":"/jira/secure/useravatar?avatarId=10122"},"completed":true,
        "subtasks":[]},{"name":"story2","key":"WIRED-3","id":10402,"timestamp":1405438117393,
        "contributor":{"id":"admin","name":"admin","avatar":"/jira/secure/useravatar?avatarId=10122"},
        "completed":false,"subtasks":[]},{"name":"story3","key":"WIRED-4","id":10403,"timestamp":1405458785061,
        "contributor":{"id":"admin","name":"admin","avatar":"/jira/secure/useravatar?avatarId=10122"},
        "completed":true,"subtasks":[]}]}]},
        {"name":"Scrum1","key":"TESTSCRUM","id":10101,"description":"","timestamp":1405431614000,"epics":[
        {"name":"Other Stories","description":"Stories without an epic","key":"NOKEY","id":-1,"timestamp":1405430232445,
        "stories":[{"name":"test 2","key":"ESCRUM-33","id":186652,"timestamp":1405430232445,
    ...
    it('should sort the projects based on the timestamp', function(){    
        ...
        expect(project1.id).toEqual(10400);
       	expect(project1.timestamp).toEqual(1405458785061);
